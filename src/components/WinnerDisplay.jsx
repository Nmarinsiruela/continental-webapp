      ...
      <div className="max-w-3xl mx-auto">
        <div className="bg-gradient-to-r from-yellow-400 to-yellow-600 rounded-lg shadow-2xl p-8 mb-6 text-center">
          ...
          <div className="bg-white rounded-lg p-6">
            <p className="text-2xl font-semibold text-gray-700 mb-2">Ganador</p>
            <p className="text-5xl font-bold text-yellow-600 mb-2">
              {winner?.name}
            </p>
            <p className="text-3xl text-gray-600">
              Puntuación: {winner?.totalScore}
            </p>
          </div>
        </div>

        <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
          <h3 className="text-2xl font-bold mb-4 text-gray-800">Clasificación Final</h3>
